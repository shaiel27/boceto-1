...
INSERT IGNORE INTO Office (Name_Office, Building, Telephone_Number) VALUES
('Oficina de Recursos Humanos', 'Edificio Central', '555-1001'),
('Departamento de Tecnología', 'Edificio Central', '555-1002'),
('Secretaría General', 'Edificio A', '555-1003'),
('Tesorería Municipal', 'Edificio B', '555-1004'),
('Oficina de Obras Públicas', 'Edificio C', '555-1005'),
('Departamento de Salud', 'Edificio D', '555-1006'),
('Oficina de Educación', 'Edificio E', '555-1007'),
('Secretaría de Transporte', 'Edificio F', '555-1008'),
('Departamento de Ambiente', 'Edificio G', '555-1009'),
('Oficina de Cultura', 'Edificio H', '555-1010');
...
INSERT IGNORE INTO Technicians_Service (Fk_Technicians, Fk_TI_Service) VALUES
(1, 1), (1, 2), (1, 3),
(2, 1), (2, 2), (2, 3),
(3, 1), (3, 2), (3, 3),
(4, 1), (4, 2), (4, 3),
...
-- ==========================================
-- 7. INSERCIÓN DE TICKETS (8 casos - SIN ESPECIFICAR ID - AUTOINCREMENT)
-- ==========================================

INSERT IGNORE INTO Service_Request (Ticket_Code, Fk_Users, FK_Office, Fk_TI_Service, Fk_Technician_Current, Subject, Property_number, Description, Request_Type, User_Priority, System_Priority, Status) VALUES
('TKT-2024-001', 11, 1, 3, 1, 'Computadora no enciende', 'PC-HR-001', 'La computadora de escritorio no enciende al presionar el botón de power', 'Incidente', 'Alta', 'Alta', 'En Progreso'),
('TKT-2024-002', 12, 2, 2, 2, 'Microsoft Office no funciona', 'PC-TECH-003', 'No puedo abrir los documentos de Word y Excel, se cierran solos', 'Incidente', 'Media', 'Media', 'Pendiente'),
('TKT-2024-003', 13, 3, 1, 3, 'Sin conexión a internet', 'PC-SEC-005', 'No tengo acceso a internet desde hace 2 días', 'Incidente', 'Alta', 'Alta', 'Resuelto'),
('TKT-2024-004', 14, 4, 3, 4, 'Impresora no imprime', 'IMP-TES-001', 'La impresora HP LaserJet no responde cuando intento imprimir', 'Incidente', 'Media', 'Media', 'En Progreso'),
('TKT-2024-005', 15, 5, 3, 5, 'Windows muy lento', 'PC-OBR-002', 'El sistema operativo funciona extremadamente lento', 'Incidente', 'Media', 'Baja', 'Pendiente'),
('TKT-2024-006', 16, 6, 1, 6, 'No puedo enviar correos', 'PC-SAL-001', 'Outlook no envía correos, marca error de servidor', 'Incidente', 'Alta', 'Media', 'En Progreso'),
('TKT-2024-007', 17, 7, 2, 7, 'No puedo crear tickets', 'PC-EDU-003', 'El sistema de tickets me da error al intentar crear una nueva solicitud', 'Incidente', 'Media', 'Alta', 'Resuelto'),
('TKT-2024-008', 18, 8, 3, 8, 'Sospecha de virus', 'PC-TRANS-004', 'El antivirus detectó una amenaza pero no puede eliminarla', 'Incidente', 'Alta', 'Alta', 'En Progreso');
