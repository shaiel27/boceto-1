...
-- Script completo para crear la base de datos tickets_system
-- Versión final: esquema + datos iniciales
-- Compatible con XAMPP (MySQL / phpMyAdmin)
-- Contraseña por defecto: password123
-- Ejecutar: mysql -u root -p < tickets_system_final.sql
-- ============================================================
...
-- ============================================================
-- 2. INFRAESTRUCTURA INSTITUCIONAL (OFICINAS)
-- ============================================================

CREATE TABLE IF NOT EXISTS Office (
    ID_Office INT AUTO_INCREMENT PRIMARY KEY,
    Name_Office VARCHAR(100) NOT NULL,
    Office_Type VARCHAR(50) DEFAULT NULL COMMENT 'Direction, Division, Coordination',
...
CREATE TABLE IF NOT EXISTS Technicians (
    ...
    Status VARCHAR(20) DEFAULT 'Disponible' COMMENT "Estado: Disponible, Ocupado, Inactivo, Fuera de Servicio",
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- ============================================================
-- 9. SOLICITUDES DE ASISTENCIA (TÉCNICOS)
-- ============================================================
