...
```
http://192.168.0.137:3000   ← Web
http://192.168.0.137:8000   ← Backend API
exp://192.168.0.137:8081     ← Expo Metro Bundler
```
...
```ts
const API_HOST = '192.168.0.137';
export const API_BASE_URL = `http://${API_HOST}:8000`;
```

> Después de cambiar, reinicia con:
> ```powershell
> $env:EXPO_PACKAGER_PROXY_URL = "http://192.168.0.137:8081"
...
- Si el QR apunta a IP incorrecta: `$env:EXPO_PACKAGER_PROXY_URL="http://192.168.0.137:8081"; npx expo start --clear`
